          ...
          children: [
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                width: double.infinity,
                decoration: BoxDecoration(
                  border: Border.all(color: appHint(context)),
                  borderRadius: BorderRadius.circular(12),
...
///شروط البروفيل الي بتوقف التحليل
...
//                   }
                  ...
                  try {
                    ...
                    // Report id (GUID) from the analyze response
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => ResultScreen(
                          reportId: reportId,
                          originalImageUrl:
                              "${ApiService.baseUrl}/api/reports/$reportId/original-image",
                          heatmapImageUrl:
                              "${ApiService.baseUrl}/api/reports/$reportId/heatmap-image",
                          diagnosis: diagnosis,

                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        IconButton(
                          icon: Icon(Icons.language, color: appText(context)),
                          onPressed: () {
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        //'Email Address',
                        labelStyle: TextStyle(color: appHint(context)),
                        prefixIcon:
                        Icon(Icons.email, color: appHint(context)),
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        labelStyle: TextStyle(color: appHint(context)),
                        prefixIcon: Icon(
                            Icons.lock, color: appHint(context)
                        ),
                        ...
                        onPressed: isLoading
                            ...
                            : () async {
                                ...
                                // }
                                  ...
                                  if (errorKey.startsWith('serverError')) {
                                    errorMessage =
                                        AppLocalizations.of(context)!.serverError;
                                  } else {
                                    switch (errorKey) {
